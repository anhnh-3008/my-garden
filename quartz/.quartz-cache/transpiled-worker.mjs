...
function TagList({ fileData }) {
  ...
  if (tags && tags.length > 0) {
    return /* @__PURE__ */ jsx21("ul", { class: "tags", children: tags.map((tag) => {
      const display = `#${tag}`;
      const linkDest = baseDir + `/tags/${slugTag(tag)}`;
      return /* @__PURE__ */ jsx21("li", { children: /* @__PURE__ */ jsx21("a", { href: linkDest, class: "internal tag-link", children: display }) });
    }) });
  } else {
    return null;
  }
...
var Graph_default = /* @__PURE__ */ __name((opts) => {
  function Graph() {
    ...
    return /* @__PURE__ */ jsxs12("div", { class: "graph", children: [
      /* @__PURE__ */ jsx22("h3", { children: "Graph View" }),
      /* @__PURE__ */ jsxs12("div", { class: "graph-outer", children: [
        /* @__PURE__ */ jsx22("div", { id: "graph-container", "data-cfg": JSON.stringify(localGraph) }),
        /* @__PURE__ */ jsx22(
          "svg",
          {
            version: "1.1",
      ...
      /* @__PURE__ */ jsx22("div", { id: "global-graph-outer", children: /* @__PURE__ */ jsx22("div", { id: "global-graph-container", "data-cfg": JSON.stringify(globalGraph) }) })
    ] });
  }
  __name(Graph, "Graph");
...
function Backlinks({ fileData, allFiles }) {
  ...
  return /* @__PURE__ */ jsxs13("div", { class: "backlinks", children: [
    /* @__PURE__ */ jsx23("h3", { children: "Backlinks" }),
    /* @__PURE__ */ jsx23("ul", { class: "overflow", children: backlinkFiles.length > 0 ? backlinkFiles.map((f) => /* @__PURE__ */ jsx23("li", { children: /* @__PURE__ */ jsx23("a", { href: resolveRelative(fileData.slug, f.slug), class: "internal", children: f.frontmatter?.title }) })) : /* @__PURE__ */ jsx23("li", { children: "No backlinks found" }) })
  ] });
}
...
var Search_default = /* @__PURE__ */ __name(() => {
  function Search() {
    return /* @__PURE__ */ jsxs14("div", { class: "search", children: [
      /* @__PURE__ */ jsxs14("div", { id: "search-icon", children: [
        /* @__PURE__ */ jsx24("p", { children: "Search" }),
        /* @__PURE__ */ jsx24("div", {}),
        /* @__PURE__ */ jsxs14(
          "svg",
          {
            ...
            children: [
              /* @__PURE__ */ jsx24("title", { id: "title", children: "Search" }),
              /* @__PURE__ */ jsx24("desc", { id: "desc", children: "Search" }),
              /* @__PURE__ */ jsxs14("g", { class: "search-path", fill: "none", children: [
                /* @__PURE__ */ jsx24("path", { "stroke-linecap": "square", d: "M18.5 18.3l-5.4-5.4" }),
                /* @__PURE__ */ jsx24("circle", { cx: "8", cy: "8", r: "7" })
              ] })
            ]
          }
        )
      ] }),
      /* @__PURE__ */ jsx24("div", { id: "search-container", children: /* @__PURE__ */ jsxs14("div", { id: "search-space", children: [
        /* @__PURE__ */ jsx24(
          "input",
          {
            autocomplete: "off",
        ...
        /* @__PURE__ */ jsx24("div", { id: "results-container" })
      ] }) })
    ] });
  }
...
var Footer_default = /* @__PURE__ */ __name((opts) => {
  function Footer() {
    ...
    return /* @__PURE__ */ jsxs15("footer", { children: [
      /* @__PURE__ */ jsx25("hr", {}),
      ...
      /* @__PURE__ */ jsx25("ul", { children: Object.entries(links).map(([text, link]) => /* @__PURE__ */ jsx25("li", { children: /* @__PURE__ */ jsx25("a", { href: link, children: text }) })) })
    ] });
  }
...
import { Fragment as Fragment5, jsx as jsx26 } from "preact/jsx-runtime";
var DesktopOnly_default = /* @__PURE__ */ __name((component) => {
  if (component) {
    let DesktopOnly2 = function(props) {
      return /* @__PURE__ */ jsx26(Component, { displayClass: "desktop-only", ...props });
    };
    ...
    return () => /* @__PURE__ */ jsx26(Fragment5, {});
  }
}, "default");
...
var MobileOnly_default = /* @__PURE__ */ __name((component) => {
  if (component) {
    let MobileOnly2 = function(props) {
      return /* @__PURE__ */ jsx27(Component, { displayClass: "mobile-only", ...props });
    };
...
import { jsx as jsx28, jsxs as jsxs16 } from "preact/jsx-runtime";
...
var ComponentResources = /* @__PURE__ */ __name((opts) => {
  const { fontOrigin } = { ...defaultOptions11, ...opts };
  return {
